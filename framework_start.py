...
# np.savetxt('data_test.txt', [sample.system.Y, sample.system.Y])
...
# # # ------ spectrum training and test --- not working!!
...
#                version=version)  #another number to note trained model different than noarmal u
...
# np.savetxt('data_spectrum_yhat.txt', simulation.yhat)
...
#
#
# test_y = np.loadtxt('data_test_y.txt')
# test_yhat = np.loadtxt('data_test_yhat.txt')
# test_yhat_spectrum = np.loadtxt('data_spectrum_yhat.txt')
...
# ax[1].set_ylabel('b')
# ax[1].xaxis.set_tick_params(labelsize=ticksize)
# # ax[2].plot(ref_spectrum, 'g', label='spectrum')
# # ax[2].legend()
# # ax[2].xaxis.set_tick_params(labelsize=ticksize)
